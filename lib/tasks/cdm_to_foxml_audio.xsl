  ...
  <xsl:value-of select="manifest/foxml_dir" />
                ...
                <xsl:for-each select="record">
                        <xsl:variable name="cdmfile">
                                ...
                                <xsl:value-of select="concat('cdm:',$collection,'x',CONTENTdm_number)"/>
                        </xsl:variable>
                        
                        <xsl:variable name="pid">
                                <xsl:value-of select="concat('audio:',$cdmfile)" />
                        </xsl:variable>
                        ...
                        <exsl:document method="xml" href="{$foxmlDir}/{$cdmfile}.xml">
                                ...
                                <xsl:element name="foxml:digitalObject"
                                        ...
                                        <foxml:datastream ID="avMetadata" STATE="A" CONTROL_GROUP="X" VERSIONABLE="true">
                                          <foxml:datastreamVersion ID="avMetadata.0" LABEL="ContentDM metadata" MIMETYPE="text/xml">
                                            <foxml:xmlContent>
                                              <fields>
                                                 
                                                          <xsl:for-each select="AVSOURCE">  
                                                                  <xsl:element name="avsource">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          
                                                          <xsl:for-each select="Clip_Summary">  
                                                                  <xsl:element name="clip_summary">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          
                                                          <xsl:for-each select="Date_Broadcast">  
                                                                  <xsl:element name="date_broadcast">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          
                                                          <xsl:for-each select="Ensemble_Identifier">  
                                                                  <xsl:element name="ensemble_identifier">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          
                                                          <xsl:for-each select="Timecode_Begin">  
                                                                  <xsl:element name="timecode_begin">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          
                                                          <xsl:for-each select="Timecode_End">  
                                                                  <xsl:element name="timecode_end">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          ...
                                                          <xsl:for-each select="Original_Source_Summary">  
                                                                  <xsl:element name="original_source_summary">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          
                                                          <xsl:for-each select="Original_Source_Title">  
                                                                  <xsl:element name="original_source_title">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
