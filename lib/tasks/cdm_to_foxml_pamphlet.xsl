    ...
    <xsl:value-of select="manifest/foxml_dir" />
                ...
                <xsl:for-each select="record">
                        ...
                        <xsl:variable name="pid">
                                <xsl:value-of select="concat('pamphlet:',$cdmfile)" />
                        </xsl:variable>
                                          ...
                                          <foxml:datastreamVersion ID="descMetadata.0" LABEL="ContentDM metadata" MIMETYPE="text/xml">
                                            <foxml:xmlContent>
                                              ...
                                              <xsl:for-each select="Author">  
                                                          ...
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Date_of_Publication">  
                                                                  <xsl:element name="date_of_publication">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Internal_Note">  
                                                                  <xsl:element name="internal_note">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each>
                                                          <xsl:text>&#xa;</xsl:text>
