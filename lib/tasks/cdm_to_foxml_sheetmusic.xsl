    ...
    <xsl:value-of select="manifest/foxml_dir" />
                ...
                <xsl:for-each select="record">
                        ...
                        <xsl:variable name="pid">
                                <xsl:value-of select="concat('sheetmusic:',$cdmfile)" />
                        </xsl:variable>
                                        ...
                                        <foxml:datastream ID="descMetadata" STATE="A" CONTROL_GROUP="X" VERSIONABLE="true">
                                          <foxml:datastreamVersion ID="descMetadata.0" LABEL="ContentDM metadata" MIMETYPE="text/xml">
                                            <foxml:xmlContent>
                                              <fields>
                                              <xsl:text>&#xa;</xsl:text>
                                              <xsl:for-each select="Adapted_From">  
                                                                  <xsl:element name="adapted_from">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          ...
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Cover_Description">  
                                                                  <xsl:element name="cover_description">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Date_Range">  
                                                                  <xsl:element name="date_range">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Display_Format">  
                                                                  <xsl:element name="display_format">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Donor_Information">  
                                                                  <xsl:element name="donor_information">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Lithographer_Printer">  
                                                                  <xsl:element name="lithographer_printer">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          ...
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Stereotypical_Object_Note">  
                                                                  <xsl:element name="stereotypical_object_note">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each>
                                                          <xsl:text>&#xa;</xsl:text>
