    ...
    <xsl:value-of select="manifest/foxml_dir" />
                ...
                <xsl:for-each select="record">
                        ...
                        <xsl:variable name="pid">
                                <xsl:value-of select="concat('manuscript:',$cdmfile)" />
                        </xsl:variable>
                                        ...
                                        <foxml:datastream ID="descMetadata" STATE="A" CONTROL_GROUP="X" VERSIONABLE="true">
                                          <foxml:datastreamVersion ID="descMetadata.0" LABEL="ContentDM metadata" MIMETYPE="text/xml">
                                            <foxml:xmlContent>
                                              <fields>
                                              <xsl:text>&#xa;</xsl:text>
                                              <xsl:for-each select="Creator_Organization">  
                                                                  <xsl:element name="creator_organization">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Creator_Person">  
                                                                  <xsl:element name="creator_person">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Other_Creator_Organization">  
                                                                  <xsl:element name="other_creator_organization">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
                                                          <xsl:for-each select="Other_Creator_Person">  
                                                                  <xsl:element name="other_creator_person">  
                                                                          <xsl:value-of select="." />  
                                                                  </xsl:element>
                                                          </xsl:for-each> 
                                                          <xsl:text>&#xa;</xsl:text>
